...
import 'package:lawyermanagement/components/case_details/comment_FB.dart';
import 'package:lawyermanagement/models/case_files_model.dart';
import 'package:lawyermanagement/models/case_notes_model.dart';
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () => Share.share(
                            'View case details on our app using unique key : ${caseDetails.uniqueCode}'),
                        icon: const Icon(
                  ...
                  Expanded(
                    child: FutureBuilder(
                        future: CasesApi()
                            .fetchCaseComments(caseId: caseDetails.caseId),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            CaseNotesModel caseNotes =
                                CaseNotesModel.fromJson(snapshot.data);
                            return ListView.builder(
                              itemCount: caseNotes.notes!.length,
                              itemBuilder: (context, index) => Container(
                                ...
                                child: Text(
                                  "${caseNotes.notes![index]!.commentBody!}\n${caseNotes.notes![index]!.dateAdded!}",
                                  style: const TextStyle(
                                    fontSize: 16,
                                    color: Colors.grey,
                                  ),
