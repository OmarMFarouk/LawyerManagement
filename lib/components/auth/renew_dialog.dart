                        ...
                        MaterialPageRoute(
                            builder: (context) => PaymentGateway(
                                  ...
                                  email: BlocProvider.of<AuthCubit>(context)
                                      ...
                                      .text,
                                  url:
                                      '${ApiEndPoints.checkOut}&months_paid=${BlocProvider.of<AuthCubit>(context).selectedBundle!.bundleMonthsCount}&email=${BlocProvider.of<AuthCubit>(context).emailCont.text}&title=${BlocProvider.of<AuthCubit>(context).selectedBundle!.bundleTitle}&price=${double.parse(BlocProvider.of<AuthCubit>(context).selectedBundle!.bundlePrice.toString())}&is_renew=true',
                                )));
                  }
                },
